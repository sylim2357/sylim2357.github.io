...
특정 시각($$t$$)에서, 해당 주식을 몇주($$bs(t)$$)나 얼마($$bp(t)$$)에 사고(bid), 몇주($$as(t)$$)나 얼마($$ap(t)$$)에 팔고(ask)자 낸 주문이 각 가격대에 몇 주문이나 되는지를 기록한 것이 호가 데이터이다.
...
![Results1](/assets/images/model-based-rl-for-predictions-and-control-for-lob-04.png)
